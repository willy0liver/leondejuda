...
export class PrerequisitesComponent {
  ...
  players: Player[] = [
    ...
    { nombre: "Marco Paz", AP: 0, CC: 0, RF: 5, CI: 100, RT: 100 },
    ...
    { nombre: "Gerson Bautista", AP: 100, CC: 30, RF: 0, CI: 100, RT: 100 },
    { nombre: "Segundo Laynes", AP: 100, CC: 30, RF: 16, CI: 100, RT: 100 },
    { nombre: "Ivan Morales", AP: 100, CC: 30, RF: 16, CI: 100, RT: 100 },
    ...
    { nombre: "Maycol Chavez", AP: 100, CC: 16, RF: 16, CI: 100, RT: 100 },
    { nombre: "Maximiliano Farroñan", AP: 100, CC: 30, RF: 11, CI: 100, RT: 100 },
    { nombre: "Julio Cotrina", AP: 0, CC: 28, RF: 13, CI: 100, RT: 100 },
    ...
    { nombre: "Klismar Chinchay", AP: 100, CC: 30, RF: 16, CI: 100, RT: 100 },
  ].sort((a, b) => {
